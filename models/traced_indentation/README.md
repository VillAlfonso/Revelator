# Indentation / Canal Light Tracing

**Category:** Traced  
**Model ID:** `traced_indentation`  
...
Forgery where original was placed on top and traced with pressure, leaving grooves.
...
ESDA (Electrostatic Detection Apparatus) reveals indentations invisible to naked eye.
...
2. Update `TRAINING_STATUS["traced_indentation"] = True` in main.py
3. Restart server
