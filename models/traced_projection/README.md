# Projection Process Tracing

**Category:** Traced  
**Model ID:** `traced_projection`  
...
Forgery created using light box or projector to trace original onto new document.
...
Often produces the most convincing traced forgeries. Look for lack of natural pen lifts.
...
2. Update `TRAINING_STATUS["traced_projection"] = True` in main.py
3. Restart server
