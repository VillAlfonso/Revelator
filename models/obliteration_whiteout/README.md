# Obliteration: White Out / Correction Fluid

**Category:** Obliteration  
**Model ID:** `obliteration_whiteout`  
...
Original content covered with white correction fluid (Wite-Out, Liquid Paper).
...
Transmitted light shows opaque spots clearly. Correction fluid often fluoresces differently.
...
```bash
cd models/obliteration_whiteout
python train.py
```
...
2. Update `TRAINING_STATUS["obliteration_whiteout"] = True` in main.py
3. Restart server
