...
CLASS_TO_GEMINI = {
    ...
    "counterfeit": ("currency_analysis", ["currency_analysis", "digital_desktop", "other"], "a possible banknote or official-document authenticity case (verify from the image)"),
