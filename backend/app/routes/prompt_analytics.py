...
def get_prompt_analysis():
    ...
    return {
        ...
        "aux_prompts": [
            {"name": "SYSTEM_PROMPT", "word_count": 4562, "char_count": 31096, "purpose": "Main classification logic with category definitions, branching rules, and user-context injection."},
        ...
        "categories": [
            ...
            {"id": "currency_analysis", "label": "Currency", "group": "currency", "word_count": 203, "detail_level": "HIGH", "first_line": "Counterfeit banknote. A genuine banknote is NOT a forgery - flag only with a specific counterfeit sign, otherwise no_forgery_detected.", "indicators": ["no raised intaglio relief","watermark/thread printed on surface or missing","blurry/broken microprint","photocopy dot rosettes","colour-shift ink that does not shift","wrong-font or mismatched serials","Philippine peso (BSP) security features"], "distinctions": [{"target": "no_forgery_detected", "reason": "Genuine money is authentic; currency_analysis means counterfeit detected, not merely 'this is money'"}]},
        ],
        "overlaps": [
